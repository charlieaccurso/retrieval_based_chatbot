...
class ChatBot:
  ...
  #define .chat() below:
  def chat(self):
    user_message= input("Welcome! What question can I help answer?\n> ")
  ...
  def find_entities(self, user_message):
    ...
    # sort the word2vec_result by ascending similarity score
  ...
  def respond(self, user_message):
    ...
    input_message= input("Ask another question, or end the conversation.\n> ")
